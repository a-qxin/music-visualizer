...
export interface InstrumentPropsTEST {
  state: AppState;
  dispatch: React.Dispatch<DispatchAction>;
  name: string;
  synth: Tone.Sampler;
  setSynth: (f: (oldSynth: Tone.Sampler) => Tone.Sampler) => void;
}

export class Instrument2 {
  public readonly name: string;
  public readonly component: React.FC<InstrumentPropsTEST>;

  constructor(name: string, component: React.FC<InstrumentPropsTEST>) {
    this.name = name;
